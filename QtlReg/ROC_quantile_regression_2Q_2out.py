...
model_median.load_state_dict(torch.load('results/QR_nwe_results/VAE_QR_brain_0.5.pth'))
...
save_image(comparison,
           'results/QR_nwe_results/recon_QR_pval_brain.png',
           nrow=16,
           scale_each=False,
           normalize=True,
           range=(0, 1))
...
comparison = torch.cat([
    in_data[n, 0:1], out_median[n, 0:1], out_Q1[n, 0:1],
    in_data[n, 1:2], out_median[n, 1:2], out_Q1[n, 1:2],
    in_data[n, 2:3], out_median[n, 2:3], out_Q1[n, 2:3]
])

save_image(comparison,
           'results/QR_nwe_results/T2_brain.png',
           nrow=16,
           scale_each=False,
           normalize=True,
           range=(0, 1))
